...
namespace BeanCannon.Presentation.MaterializedDesktopUI.Helpers
{
	/// <summary>
	/// FROM https://stackoverflow.com/questions/456063/adding-button-into-a-listview-in-winforms
	/// </summary>
